...
from web.services.zotero_service import ZoteroService, get_zotero_service
...
def set_test_env():
    ...
    os.environ.pop("ZOTERO_API_KEY", None)  # Ensure not configured for most tests
...
class TestZoteroServiceSingleton:
    """Test Zotero service singleton pattern."""

    def test_get_zotero_service_singleton(self):
        """Test that get_zotero_service returns same instance."""
        service1 = get_zotero_service()
        service2 = get_zotero_service()
